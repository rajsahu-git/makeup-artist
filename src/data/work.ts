...
export const work: WorkItem[] = [
  { id: "bridal-01", title: "Amara, Kensington", category: "bridal", code: "No. 01", aspect: "4/5" },
  { id: "editorial-01", title: "Vogue Italia test shoot", category: "editorial", code: "No. 02", aspect: "3/4" },
  { id: "glam-01", title: "BAFTA after-party", category: "glam", code: "No. 03", aspect: "1/1" },
  { id: "bridal-02", title: "Priya, Cotswolds", category: "bridal", code: "No. 04", aspect: "5/4" },
  ...
  { id: "bridal-03", title: "Freya, Loch Lomond", category: "bridal", code: "No. 08", aspect: "1/1" },
